...
(document-service). Only exercises the pure secret-validation path
...
def _valid_production_settings():
    ...
    settings.database_url = "postgresql://docmgmt:S3cur3-Unique-Pw@postgres:5432/docmgmt"
...
def test_default_database_password_fails_in_production(restore_settings):
    _valid_production_settings()
    settings.database_url = "postgresql://docmgmt:docmgmt@postgres:5432/docmgmt"
